...
dist=getResult(rs2.getString(20));
  ...
  System.out.println("UPDATE gss_range r SET  r.profil_id='"+pere_profil +"',r.rng_pq='"+pq+"',r.rng_statut='"+statu +"',r.rng_swap='"+swap +"',r.rng_tpd='"+test +"',r.rng_promotion='"+promo +"',r.rng_priorite='"+prior +"',r.rng_packaged='"+p +"',r.rng_transfert='"+t +"',r.rng_sortie='"+s +"',r.rng_reintegration='"+r +"',r.rng_whs='"+whp +"',r.rng_dist='"+dist +"' where  (r.rng_id_parent='"+code1+"')and (r.act_id_parent='"+code2+"')");
 h = st1.executeUpdate("UPDATE gss_range r SET  r.profil_id='"+pere_profil +"',r.rng_pq='"+pq+"',r.rng_statut='"+statu +"',r.rng_swap='"+swap +"',r.rng_tpd='"+test +"',r.rng_promotion='"+promo +"',r.rng_priorite='"+prior +"',r.rng_packaged='"+p +"',r.rng_transfert='"+t +"',r.rng_sortie='"+s +"',r.rng_reintegration='"+r +"',r.rng_whs='"+whp +"',r.rng_dist='"+dist +"' where  (r.rng_id_parent='"+code1+"')and (r.act_id_parent='"+code2+"')");
...
JasperExportManager.exportReportToPdfFile(jasperPrint, "'"+set+"'.pdf");

response.setContentType("application/octet-stream");
response.setHeader("Content-Disposition","attachment; filename=\"'"+set+"'.pdf\"");
