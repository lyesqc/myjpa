...
public class ReceptransAction extends DispatchAction {
  ...
  return mapping.findForward("listenvoitrans");
 }
  ...
  public ActionForward recherche(ActionMapping mapping, ActionForm form,
   ...
   System.out.println("je suis ds recherche de receptrans");
   
   
   String whh=transfert1Form.getMagasin();
...
/*
  ...
  request.getSession().setAttribute("warehouse",whs);*/
   ...
   System.out.println("select whs_id from gss_warehouse where gss_warehouse.whs_adresse='"+whh+"'");
   rs1=st1.executeQuery("select whs_id from gss_warehouse where (gss_warehouse.whs_adresse='"+whh+"')");

   if (rs1.next()){
     
      whscode=rs1.getString(1).trim();
     System.out.println(whscode);
    
     
    }
   request.getSession().setAttribute("warehouserecep",whscode); 
   
  st=con.createStatement();
 //  st=con.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_READ_ONLY);
  // rs=st.executeQuery("select distinct tr.t_r_trans_type||'-'||tr.t_r_trans_whs||'-'||tr.t_r_trans_no,tr.t_r_trans_type,tr.t_r_trans_whs,tr.t_r_trans_no,dr.whs_adresse,tr.t_r_date  from gss_transaction_range tr, gss_range r, gss_transaction t, gss_warehouse d,gss_warehouse dr where tr.t_r_rng_id=r.rng_id and tr.t_r_rng_act_id=r.act_id and tr.t_r_trans_no=t.trans_no and tr.t_r_trans_type=t.trans_type and tr.t_r_trans_whs=t.whs_id and  tr.t_r_trans_type='TRA' and r.rng_inactif='A' and d.whs_id(+)=t.whs_dest and  d.whs_adresse='"+whh+"'and r.rng_transfert='C' and tr.t_r_trans_whs=dr.whs_id order by  tr.t_r_date ");
  
  System.out.println("select distinct t.trans_type||'-'||t.whs_id||'-'||t.trans_no,t.trans_type,t.whs_id,t.trans_no,dr.whs_adresse from (select distinct tr.t_r_trans_type as typ_trans,tr.t_r_trans_whs as whs ,MAX(tr.t_r_trans_no) as code,tr.t_r_rng_id,tr.t_r_rng_act_id from gss_transaction_range tr, gss_range r where tr.t_r_rng_id=r.rng_id and tr.t_r_rng_act_id=r.act_id  and  tr.t_r_trans_type='TRA' and r.rng_inactif='A' and r.rng_transfert='C' and r.rng_transfert_whs='"+whscode+"'  GROUP BY tr.t_r_trans_type,tr.t_r_trans_whs,tr.t_r_rng_id,tr.t_r_rng_act_id )aa,gss_warehouse d,gss_transaction t,gss_warehouse dr  where t.trans_no=aa.code and t.trans_type=aa.typ_trans and t.whs_id=aa.whs and t.whs_dest=d.whs_id(+)  and t.whs_id=dr.whs_id(+) and d.whs_adresse='"+whh+"' ");
  rs=st.executeQuery("select distinct t.trans_type||'-'||t.whs_id||'-'||t.trans_no,t.trans_type,t.whs_id,t.trans_no,dr.whs_adresse from (select distinct tr.t_r_trans_type as typ_trans,tr.t_r_trans_whs as whs ,MAX(tr.t_r_trans_no) as code,tr.t_r_rng_id,tr.t_r_rng_act_id from gss_transaction_range tr, gss_range r where tr.t_r_rng_id=r.rng_id and tr.t_r_rng_act_id=r.act_id  and  tr.t_r_trans_type='TRA' and r.rng_inactif='A' and r.rng_transfert='C' and r.rng_transfert_whs='"+whscode+"'  GROUP BY tr.t_r_trans_type,tr.t_r_trans_whs,tr.t_r_rng_id,tr.t_r_rng_act_id )aa,gss_warehouse d,gss_transaction t,gss_warehouse dr  where t.trans_no=aa.code and t.trans_type=aa.typ_trans and t.whs_id=aa.whs and t.whs_dest=d.whs_id(+)  and t.whs_id=dr.whs_id(+) and d.whs_adresse='"+whh+"' ");
     while (rs.next()){
...
con.close();
  ...
  public ActionForward ouvrir(ActionMapping mapping, ActionForm form,
   ...
   ArrayList priv =  new ArrayList() ;
    ...
    String prio=null;
    String date=null;
    Statement st,st1,st3,st4,st2 = null;
    ResultSet rs,rs1,rs3,rs4,rs2 = null;
...
String whr= (String)request.getSession().getAttribute("warehouserecep");
 ...
 try{
 rs1=st1.executeQuery("select max(trans_no) from gss_transaction  where (trans_type='RTR') and gss_transaction.whs_id ='"+whr+"'");
 ...
 String code_trans = "RTR"+"-"+whr+"-"+maxi;
 System.out.println("le code de transfert:"+code_trans);
 ...
 while (rs.next())
  {
   ...
   list.add(rang);
      ...
      con.close();    
  return mapping.findForward("receptrans");
 }
 ...
 public ActionForward Retirer(ActionMapping mapping, ActionForm form,
  ...
  public ActionForward valider(ActionMapping mapping, ActionForm form,
   ...
   String whs = (String)request.getSession().getAttribute("entrepotsource");
...
/*   max = (String)request.getSession().getAttribute("max");
   ...
   try{
	  	  rs6=st6.executeQuery("select max(trans_no) from gss_transaction  where (trans_type='RTR') and (whs_id='"+whr+"')");
...
/*
   ...
   listt=transfert1Form .getListajouter();
              ...
              /*    System.out.println("insert into gss_transaction values ('"+max+"','RTR','"+whr+"',SYSDATE,'"+idact+"','','"+doc+"','"+note+"','','','')");
    h = st.executeUpdate("insert into gss_transaction values ('"+max+"','RTR','"+whr+"',SYSDATE,'"+idact+"','','"+doc+"','"+note+"','','','')");
   */
   ...
   System.out.println(size);
      ...
      transfert1Form.setHiddenTest("collection null");
       ...
       System.out.println("insert into gss_transaction values ('"+max+"','RTR','"+whr+"',SYSDATE,'"+idact+"','','"+doc+"','"+note+"','','','"+whs+"')");
      h = st.executeUpdate("insert into gss_transaction values ('"+max+"','RTR','"+whr+"',SYSDATE,'"+idact+"','','"+doc+"','"+note+"','','','"+whs+"','','N')");
    ...
    //rs2=st2.executeQuery("select rng_start,rng_end,rng_id,act_id,profil_id,art_id,rng_pq,rng_statut,rng_swap,trans_type,whs_id,trans_no,rng_promotion,rng_priorite,rng_packaged,rng_transfert,rng_sortie,rng_reintegration,rng_whs,rng_dist,rng_packaging_whs,rng_sortie_whs,rng_reintegration_whs,rng_transfert_whs from gss_range r where (rng_inactif ='A')and r.rng_transfert=('C') and  r.rng_tpd is null");
    ...
    System.out.println("select rng_start,rng_end,rng_id,act_id,profil_id,art_id,rng_pq,rng_statut,rng_tpd,trans_type,whs_id,trans_no,rng_promotion,rng_priorite,rng_packaged,rng_transfert,rng_sortie,rng_reintegration,rng_whs,rng_dist,rng_packaging_whs,rng_sortie_whs,rng_reintegration_whs,rng_transfert_whs from gss_range r where  r.rng_id='"+rng_id+"' and r.act_id='"+act_id+"'");  
     ...
     { 
      ...
      h2 = st7.executeUpdate("insert into gss_range values ('"+res1+"','"+idact+"',decode('"+pfp+"','null',null,'"+pfp+"'),'"+arp+"','"+sta+"','"+ind+"','"+rp+"','"+acp+"','A',SYSDATE,'',decode('"+pq+"','null',null,'"+pq+"'),'"+statu+"','RTR','"+whr+"','"+max+"','','',decode('"+promo+"','null',null,'"+promo+"'),decode('"+prior+"','null',null,'"+prior+"'),'"+p+"','T','"+s+"','"+r+"','"+whr+"',decode('"+dist+"','null',null,'"+dist+"'),decode('"+whspack+"','null',null,'"+whspack+"'),decode('"+whssor+"','null',null,'"+whssor+"'),decode('"+whsrentegr+"','null',null,'"+whsrentegr+"'),'"+whs+"')");
      
      h3 = st9.executeUpdate("insert into gss_transaction_range values ('RTR','"+whr+"','"+max+"','"+res1+"','"+idact+"',SYSDATE)");
 ...
 h8 = st12.executeUpdate("UPDATE gss_range SET rng_inactif = 'I',rng_inactif_date=sysdate WHERE (rng_id='"+rp+"')and (act_id='"+acp+"') and rng_inactif='A' ");
   ...
   //   h8 = st12.executeUpdate("UPDATE gss_range SET rng_inactif = 'I',rng_inactif_date=sysdate WHERE (rng_id='"+rp+"')and (act_id='"+acp+"')");
    ...
    String num="RTR"+"-"+whr+"-"+max;
    request.setAttribute("num", num);
    System.out.println("le num de transaction"+num);
   return mapping.findForward("menu");
   
   
/*	editrapport( request,response,"RTR",whr,max);
   
  ActionForward  forward = new RedirectingActionForward();
        forward.setPath("/receptrans.do?hidden=recherche");
        return forward; */
    
    //return null;
    
   // return mapping.findForward("receptranspac");
//  return null;
    }
