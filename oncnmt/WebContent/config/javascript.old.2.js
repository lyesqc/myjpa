...
document.loginForm.submit();
   ...
   function loginTest(){
      ...
      if (document.loginForm.hiddenTest.value =="Erreur user/pass")
		        {  
		            alert("Erreur lors de l'authentification. VQtrifiez votre Username/Password.!");
		            document.loginForm.username.value="";
		            document.loginForm.password.value="";
		            document.loginForm.username.focus();
		        }
		        
	  if (document.loginForm.hiddenTest.value =="status dQtsactivQt")
		        {  
		            alert("votre Statut est dQtsactivQt, Contactez votre administrateur ");
		            document.loginForm.username.value="";
		            document.loginForm.password.value="";
		            document.loginForm.username.focus();
		        }
		        
	if (document.loginForm.hiddenTest.value =="refusQt")
		        {  
		            alert("vous n'avez pas l'accQts Qt GSS, Contactez votre administrateur ");
		            document.loginForm.username.value="";
		            document.loginForm.password.value="";
		            document.loginForm.username.focus();
		        }
...
////////////////////////////////
 ...
 function testVid2new(frm){
  ...
  alert("Range invalid : numQtro debut > numQtro fin");
    } else
  if (trouver=="false"){
  ...
  frm.submit();
   ...
   function testVid2(frm){
  alert(frm.art_id.value);
  var trouver ="false";
   
     if (frm.profil.disabled==false)
     {
       if (frm.art_id.value=="" ||frm.ND.value==""||frm.NF.value==""||frm.profil.value=="")
          {
            alert("remplir les champs d'abord");
            trouver="true";
          }
 ...
 function testVide(){
		   ...
		   if (document.recepForm.fournisseur.value =="")
		         {alert('InsQtrer un fournisseur SVP')
		          document.recepForm.fournisseur.focus();
		            ...
		            {
		             alert('InsQtrer un numQtro de rQtfQtrence externe SVP')
		            ...
		            {
		             alert('InsQtrer un numQtro de PO SVP')
     ...
     function test(){
            ...
            document.getElementById("ND").maxLength="15";
		        ...
		        if (document.recepForm.hiddenTest.value =="range dans la base"){
		                   alert('Ce Range/ une partie de ce Range Qt dQtja QttQt rQtceptionnQt !')
		                   document.recepForm.hiddenTest.value="";
		         ...
		         if (document.recepForm.hiddenTest.value =="range dans la coll"){
		                   alert('Ce Range/ une partie de ce Range est dQtja choisie !')
		                   document.recepForm.hiddenTest.value="";
		         ...
		         if (document.recepForm.hiddenTest.value =="hlr diffQtrent") {
		         
		                   alert("un HLR Qt la fois, Merci!");
		                   document.recepForm.hiddenTest.value="";
		         ...
		         if (document.recepForm.hiddenTest.value =="quantitQt grande") {
		         
		                   alert("La quantitQte ne peut pas dQtpasser le 1 Milliard d'unitQts");
		                   document.recepForm.hiddenTest.value="";
		          ...
		          if (document.recepForm.hiddenTest.value =="serial dQtbut insuffisant") {
		         
		                   alert("Format de numQtro de sQtrie dQtbut insuffisante, Resaisir SVP");
		                   document.recepForm.hiddenTest.value="";
		                   document.recepForm.ND.value="";
		                   document.recepForm.NF.value="";
		                   document.recepForm.profil.value="";
		         ...
		         if (document.recepForm.hiddenTest.value =="serial fin insuffisant") {
		                   ...
		                   alert("Format de numQtro de sQtrie fin insuffisante, Resaisir SVP");
		                   document.recepForm.hiddenTest.value="";
		                   document.recepForm.ND.value="";
		                   document.recepForm.NF.value="";
		                   document.recepForm.profil.value="";
		          ...
		          if (document.recepForm.hiddenTest.value =="fin inferieur debut") {
		                   ...
		                   alert("le num sQtrie fin<num sQtrie dQtbut");
		                   document.recepForm.hiddenTest.value="";
...
document.getElementById('hiddenTest').value="demande2";
     ...
     function test1(frm){
		    ...
		    if (frm.hiddenTest.value=="range dans la coll"){
		     ...
		     if (frm.hiddenTest.value=="range n'est pas dans la coll grande") {
		                   ...
		                   alert("range n'existe pas dans la liste des ranges Qt activQt");
		                   frm.hiddenTest.value="";
		                   frm.ND.value="";
		                   frm.NF.value="";
		                   frm.profil.value="";
		      ...
		      if (frm.hiddenTest.value =="serial dQtbut insuffisant") {
		         ...
		         if (frm.hiddenTest.value =="fin inferieur debut") {
		                   ...
		                   alert("le num de sQtrie fin<num de sQtrie debut");
		                   frm.hiddenTest.value="";
		                   frm.ND.value="";
		                   frm.NF.value="";
		                   frm.profil.value="";
		         ...
		         alert("Une personne est en train d'effectuer une transaction sur le mQtme rang\n RQtQtssayer SVP");
		                   frm.hiddenTest.value="";} 
		                   
		                   
		                    if (frm.hiddenTest.value =="probleme insertion") {
		         alert("Une erreur c'est produite  veuillez RQtQtssayer de valider SVP");
		                   frm.hiddenTest.value="";
 ...
 if (frm.hiddenTest.value =="rang deja touche") {
	...
	function dmdSw(frm){
		    ...
		    if (frm.hiddenTest.value=="range dans la coll"){
		     ...
		     if (frm.hiddenTest.value=="range n'est pas dans la coll grande") {
		                   ...
		                   alert("range n'existe pas dans la liste des ranges Qt charger pour swap");
		                   frm.hiddenTest.value="";
		                   frm.ND.value="";
		                   frm.NF.value="";
		                   frm.article.value="";		                   
   ...
   var trouver = "false";
    ...
    function modifreserv(frm){
     ...
     if (frm.hiddenTest.value=="quantite reserve sup"){
		                   ...
		                   alert('la quantitQt rQtservQte est supQtrieure Qt la quantitQt disponible !')
		                    frm.hiddenTest.value="";
		                   frm.qutQt.value=""; 
		                   frm.article.value="";
		                   frm.warehouse.value="";
    ...
    if (frm.hiddenTest.value=="article dans la coll"){
		                   ...
		                   alert('Cet Article est dQtja choisi !')
		     ...
		     if (frm.hiddenTest.value=="article n'est pas dans la coll grande") {
		                   ...
		                   alert("Article n'existe pas dans la liste des article Qt rQtserver");
		     ...
		     if (frm.hiddenTest.value=="annuler"){
		                   ...
		                   alert('la rQtservation Qt QttQt annulQte');
		                   
		     }
		     
		     if (frm.hiddenTest.value=="modifier"){
		                   
		                   alert('la rQtservation Qt QttQt modifiQte');
   ...
   function reserv(frm){
     ...
     if (frm.hiddenTest.value=="SQtlectionner un destinataire SVP"){
		                   
		                   alert('SQtlectionner un destinataire SVP  !')
		                    frm.hiddenTest.value="";
		                    frm.destinataire.focus();
		                   }
	...
	if (frm.hiddenTest2.value=="remplir un destinataire"){
		     ...
		     if (frm.hiddenTest.value=="Annulation partial"){
   ...
   /*   if(frm.ND.value==""){
     ...
     alert("remplir le numQtro de sQtrie dQtbut d'abord");
     frm.ND.focus();
     }*/
     ...
     if(frm.ND.value!=""){
             ...
             if (frm.hiddenTest.value=="SCRATCH"){
                       ...
                       if (frm.ND.length<15){
                           ...
                           alert('numQtro de sQtrie Scratch insuffisant');
                           test="true";
                           frm.ND.focus();
                       }
               }
                       ...
                       alert('numQtro de sQtrie Sim insuffisant');
                       test="true";
                       frm.ND.focus();
  ...
  // code modQtrateur   
      ...
      var serial = prompt('Confirmer numQtro de sQtrie debut','');
      var serial1=frm.ND.value// pas besoin de de 'String' qui est une erreur de syntaxe mais js est faiblement typQt et les variables ont le type de la derniQtre valeur dQtclarQte
      document.getElementById('ND').style.display = "none";// cripter le champs de texte pour que l'utilisateur ne voit pas le code tapQt
      
      if(serial1==serial){
    	     frm.NF.focus();
	         alert("les deux serial sont Qtgales :"+serial)
	  }
      else{
      alert("numQtro de sQtrie incorrect reQtcrire SVP");
...
if(serial1==serial){
 ...
 else
 {
  recepForm.ND.value=serial1;
	...
	//prompt('Confirmer numQtro de sQtrie debut','');
	// document.getElementById('ND').style.display = "none";
	// serial=prompt('Confirmer numQtro de sQtrie debut','' );
	// document.recepForm.ND.focus();
...
function testVidd2(frm){
 ...
 function testt1(){
  ...
  if (document.packagingForm.hiddenTest.value =="SQtlectionner un warehouse SVP"){
		                   
		                   alert('SQtlectionner un warehouse SVP !')
		    ...
		    if (document.packagingForm.hiddenTest.value =="range dans la coll"){
		     ...
		     if (document.packagingForm.hiddenTest.value =="range n'est pas dans la coll grande") {
		                   ...
		                   alert("range n'est pas parmi les rangs prQtts pour etre packagQts");
		                   document.packagingForm.hiddenTest.value="";
...
{
                    alert("la date limite doit etre superieure Qt date d'aujourhui+5jours");
		                   document.packagingForm.hiddenTest.value="";
}		        
...
function test2(){
		    ...
		    if (envoiForm.hiddenTest.value =="range dans la coll"){
		     ...
		     if (envoiForm.hiddenTest.value =="range n'est pas dans la coll grande") {
		                   ...
		                   alert("range n'est pas parmi les rangs Qt envoyer pour packaging");
		                   envoiForm.hiddenTest.value="";
...
function test4(){
		     ...
		     if (document.transfertForm.hiddenTest.value =="SQtlectionner un warehouse source SVP"){
		    ...
		    if (transfertForm.hiddenTest.value =="range dans la coll"){
		     ...
		     if (transfertForm.hiddenTest.value =="range n'est pas dans la coll grande") {
		                   ...
		                   alert("rang n'est pas parmi les rangs Qt transfQtrer");
		                   transfertForm.hiddenTest.value="";
		    ...
		    if (rechercheForm.hiddenTest.value =="trans n'est pas egale") {
		     ...
		     if (rechercheForm.hiddenTest.value =="range n'est pas dans la coll grande") {
		                   ...
		                   alert("range n'est pas parmi les rangs Qt annuler");
		                   rechercheForm.hiddenTest.value="";
...
function test5(){
		    ...
		    if (transfert1Form.hiddenTest.value =="range dans la coll"){
		     ...
		     if (transfert1Form.hiddenTest.value =="range n'est pas dans la coll grande") {
		                   ...
		                   alert("range n'est pas parmi les rangs Qt transfQtrer");
		                   transfert1Form.hiddenTest.value="";
...
function test6(){
		    ...
		    if (transfert1Form.hiddenTest.value =="range dans la coll"){
		     ...
		     if (transfert1Form.hiddenTest.value =="range n'est pas dans la coll grande") {
		                   ...
		                   alert("ce range n'est pas parmi les rangs reQtus");
		                   transfert1Form.hiddenTest.value="";
...
if (document.reintegrForm.hiddenTest.value =="SQtlectionner un warehouse source SVP"){
		    ...
		    if (reintegrForm.hiddenTest.value =="range n'est pas dans la coll grande") {
		    	     ...
		    	     alert("ce range n'est pas parmi les rangs Qt rQtintQtgrer"+ "\nAssurer vous des critQtres de recherche  ");
		            reintegrForm.hiddenTest.value="";
		            reintegrForm.debut.value="";
	                   reintegrForm.fin.value="";
	                   reintegrForm.profil.value="";
		     ...
		     if (reintegrForm.hiddenTest.value =="range n'est pas dans la base") {
			     ...
			     if (confirm("Ce rang nQta jamais existQt sur GSS "+ "\nvoulez vous le rQtintQtgrer comme meme? ")) {    
...
function test8(){
 ...
 if (document.sortiForm.hiddenTest.value =="SQtlectionner un warehouse source SVP"){
		    ...
		    if (sortiForm.hiddenTest.value =="range dans la coll"){
		     ...
		     if (sortiForm.hiddenTest.value =="range n'est pas dans la coll grande") {
		                   ...
		                   alert("ce range n'est pas parmi les rangs Qt autoriser Qt sortir");
		                   sortiForm.hiddenTest.value="";
		          ...
		          if (sortiForm.hiddenTest.value =="quantitesup") {
		                   ...
		                   alert("Vous avez autorisez au-delQt de la quantitQt rQtservQte ");
		                   sortiForm.hiddenTest.value="";
		         ...
		         alert("Une erreur c'est produite  veuillez RQtQtssayer SVP de valider");
		                   sortiForm.hiddenTest.value="";
...
function tdp(){  
 ...
 if (document.tdpForm.hiddenTest.value =="SQtlectionner un warehouse source SVP"){
		    ...
		    if (tdpForm.hiddenTest.value =="range dans la coll"){
		     ...
		     if (tdpForm.hiddenTest.value =="range n'est pas dans la coll grande") {
		           ...
		           if (tdpForm.hiddenTest.value =="FN inferieur ND") {
		                   ...
		                   alert("le num de sQtrie FN<num de sQtrie ND");
		                   tdpForm.hiddenTest.value="";
...
var vrai="false";
		   if (document.packagingForm.parten.value =="")
		         {alert("InsQtrer un partenaire SVP")
   ...
   if(checkvalue == '')
   {
       alert('veuillez sQtlectionner une prioritQt SVP!');
        vrai ="true";
       return(false);
   }
 ...
 function valid1(){
		   if (document.envoiForm.doc.value =="")
		         {alert("voulez vous indiquer le num de rQtfQtrence externe SVP")
...
function valid3(){
  ...
  function valid4(){
		   if (document.transfert1Form.doc.value=="")
		         {alert(" vous devez indiquez un num de rQtference externe SVP")
...
/*if (confirm("Etes-vous sQtr de vouloir valider cette transaction ?")) {
     setHidden('valider',document.sortiForm)
	 sortiForm.submit(); 
}*/
...
{ alert("vous devez indiquez le code de la rQtservation  SVP")
...
document.getElementById('profil').disabled=true;
 ...
 var txt = art.options[art.selectedIndex].text;
 
 
if(txt=="SIM POSTPAID DJEZZY"||txt=="SIM PREPAID DJEZZY"||txt=="SIM PREPAID ALLO" ||txt=="SIM POSTPAID DJEZZY BUSINESS"||txt=="SIM POSTPAID DJEZZY BUSINESS CONTROL"||txt=="SIM POSTPAID DJEZZY CLASSIC"||txt=="SIM POSTPAID DJEZZY CONTROL"||txt=="SIM POSTPAID DJEZZY CONTROL 128 K"||txt=="SIM POSTPAID DJEZZY CLASSIC  128 K"||txt=="SIM POSTPAID DJEZZY BUSINESS CONTROL 128K"||txt=="SIM POSTPAID DJEZZY BUSINESS 128K")
{
document.getElementById('NF').maxLength="12";
document.getElementById('ND').maxLength="12";
document.getElementById('sup').maxLength="12";
...
{
alert("La taille du numQtro saisi est insuffisante"); 
}
...
//document.getElementById('art_id').value=document.getElementById('start_div').value;
...
{
document.getElementById('le_prompt').style.display='none';
 alert("Veuillez  resaisir le numQtro de sQtrie  SVP");
...
if (document.getElementById('hiddenTest').value=="confirmation2")
  {
	  ...
	  {
    alert("veuillez confirmer la saisi avec la touche EntrQte  svp"); 
elm.focus();
  }
}
...
{
alert("Votre session a expirQt veuillez se reconnecter SVP")}
...
function recuperparametre(param,param1,param2,param3,param4,param5)    
{
...
function check()
{
if  ((document.parametre1Form.superdist.checked==false)&&(document.parametre1Form.supereport.checked==false)&&(document.parametre1Form.superpre.checked==false)&&(document.parametre1Form.superpost.checked==false)&&
(document.parametre1Form.stockcontrol.checked==false)&&(document.parametre1Form.magaberaki.checked==false)&&(document.parametre1Form.charge.checked==false)&&(document.parametre1Form.sales.checked==false)&&
(document.parametre1Form.coordinateur.checked==false)&&(document.parametre1Form.admin.checked==false)&&(document.parametre1Form.tresor.checked==false)&&(document.parametre1Form.superviseur_compte.checked==false)&&
(document.parametre1Form.superviseur_cds.checked==false)&&(document.parametre1Form.edition.checked==false)&&(document.parametre1Form.approbateur.checked==false))

{alert("Aucun profil  nQtest sQtlectionnQt")
	return false ;}
else
{return true;}
...
{alert("veuillez choisir un distributeur  pour le profil chargQt de compte SVP ") 
...
{alert("veuillez choisir une rQtgion  pour le profil coordinateur rQtgion SVP ")
...
function valid_reintegr(){
	   if (document.reintegrForm.maga_reintegr.value=="")
	         {alert(" vous devez indiquez entrepot de rQtintQtgration SVP")
