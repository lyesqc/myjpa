...
<html:html lang="true">
 ...
 <layout:skin includeScript="true"/>
  ...
  <body onload="pre(document.activationPreForm);activer2();">
...
<jsp:include page="menu.jsp"/>  
 <hr>
     ...
     <layout:form action="/demandPre.do" method="post" onsubmit="return testersubmit();">
...
<div style="position:absolute;left:10px;width:850; height:210;overflow-y:scroll; border:solid 1px red;">   
           ...
           <layout:collectionItem title="+" property="ajouter" action="/demandPre.do?hidden=afficher" paramId="article,s_str,s_end,qute,rng_id,act_id" paramProperty="article,s_str,s_end,qute,rng_id,act_id">
...
<div style="position:absolute;left:10px;top:360px;">   
   ...
   <tr>
      ...
      <jsp:include page="champ2.jsp"/>
       ...
       <td> <layout:button onclick="ajouter(document.activationPreForm);"> Ajouter </layout:button> </td>
   </tr>
...
<div style="position:absolute;left:10px;top:440px;width:570;overflow-y:scroll;height:140; border:solid 1px red;">   
           ...
           <layout:collectionItem title="QTE" property="qt" sortable="true"></layout:collectionItem>
            <layout:collectionItem title="X" property="retirer" action="/demandPre.do?hidden=Retirer" paramId="aaa,stt,see,qtt" paramProperty="aaa,stt,see,qtt">
