...
<html:html lang="true">
 ...
 <layout:skin includeScript="true"/>
    ...
    <script>
    function désactivercombo()   
    {
    	var param ='<%=(String)request.getSession().getAttribute("parametre")%>';    
     
    	if (param=="demanddesactiv"||param=="confirmdesactiv"||param=="depackaging")
   { document.getElementById('profill').disabled=true ; }
  ...
  <body onload="désactivercombo();valid(document.activationpostForm);activer2();">
    
<jsp:include page="menu.jsp"/> 
 <hr>
 
  
     <layout:form action="/nonactiv.do" method="post" onsubmit="return false;">
  ...
  <layout:text property="act_id"  mode="H,H,H"></layout:text>
   ...
   <layout:row>
            ...
            <layout:column>
                <layout:button onclick="testValid(document.activationpostForm);">Valider</layout:button>
              </layout:column>
      ...
      <layout:column>  
      <h3 >
    <%=request.getSession().getAttribute("titre")%>
  ...
  <layout:column>
 <layout:select property="select_profill" key="Profil:" >
       <layout:option value=""></layout:option>
       <layout:options property="nomProfil"></layout:options>
        ...
        <layout:column>
           <layout:button onclick="testafficher_rang(document.activationpostForm);">afficher les rangs</layout:button>
       </layout:column>
...
<div style="position:absolute;left:10px;width:850; height:210;overflow-y:scroll; border:solid 1px red;">   
           ...
           <layout:collection name="activationpostForm" property="postpaidd"  styleClass="SCROLL" styleClass="FORM" width="850">
           ...
           <layout:collectionItem title="+" property="ajouter" action="/nonactiv.do?hidden=afficher" paramId="article,profil,s_str,s_end,qute,rng_id,act_id" paramProperty="article,profil,s_str,s_end,qute,rng_id,act_id">
...
<div style="position:absolute;left:10px;top:360px;">   
 ...
 <td> <layout:select property="profil" key="Profil:" onfocus="testArt(document.activationpostForm);">
       ...
       <td> <layout:button onclick="ajout(document.activationpostForm);"> Ajouter </layout:button> </td>
   </tr>
...
<div style="position:absolute;left:10px;top:440px;width:570;overflow-y:scroll;height:140; border:solid 1px red;">   
           ...
           <layout:collectionItem title="QTE" property="qt" sortable="true"></layout:collectionItem>
            <layout:collectionItem title="X" property="retirer" action="/nonactiv.do?hidden=Retirer" paramId="aaa,ppp,stt,see,qtt" paramProperty="aaa,ppp,stt,see,qtt">
...
<div style="position:absolute;left:620px;top:440px;width:250;height:140; border:solid 1px red;">             
        ...
        <layout:select property="profill" key="Profil :">
               ...
               <layout:option value="NEANT">NEANT</layout:option>
             </layout:select>
