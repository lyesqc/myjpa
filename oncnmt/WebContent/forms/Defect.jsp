...
<html:html lang="true">
  <head>
    ...
    <title>Affectation Défectueux</title>
 ...
 <hr>
     ...
     <layout:form action="/affecDefect.do" method="post" onsubmit="return testersubmit();">
  ...
  <layout:text property="act_id"  mode="H,H,H"></layout:text>
       ...
       <layout:row>
        ...
        <layout:column>      
              <layout:button onclick="activsubmit(tdpForm,'annuler');">Annuler</layout:button>
            </layout:column>
             <layout:column>
                <layout:button onclick="activsubmit(tdpForm,'valider');">Valider</layout:button>
            
              </layout:column>
            <layout:column>
                <layout:button onclick="activsubmit(tdpForm,'editExcel');">Expoter vers Excel</layout:button>
...
<div style="position:absolute;left:10px;width:850; height:230;overflow-y:scroll; border:solid 1px red;">   
 ...
 <layout:collectionItem title="HLR" property="hlr" sortable="true"></layout:collectionItem>
          ...
          <layout:collectionItem title="QTE" property="qte" sortable="true"></layout:collectionItem>         
           ...
           <layout:collectionItem title="+" property="ajouter" action="/affecDefect.do?hidden=afficher" paramId="article,s_str,s_end,qute,rng_id,act_id" paramProperty="article,s_str,s_end,qute,rng_id,act_id">
...
<div style="position:absolute;left:10px;top:440px;width:570;overflow-y:scroll;height:140; border:solid 1px red;">   
           ...
           <layout:collectionItem title="QTE" property="qt" sortable="true"></layout:collectionItem>
            ...
            <layout:collectionItem title="X" property="retirer" action="/affecDefect.do?hidden=Retirer" paramId="aaa,,stt,see,qtt" paramProperty="aaa,stt,see,qtt">
