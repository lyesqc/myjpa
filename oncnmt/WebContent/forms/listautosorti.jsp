...
<html:html lang="true">
  <head>
	...
	function setHidden(value){document.sortiForm.hidden.value=value;}
	</script>
   ...
   <layout:text property="hidden" mode="H,H,H" value="default">   </layout:text>
      ...
      <layout:space></layout:space>
       ...
       <layout:column width="300">
        ...
        <layout:panel  key="liste des autorisations de sortie" width="500" styleClass="FORM" height="500">
       <center>
  
          <logic:notEmpty property="listeordre" name="sortiForm">
         <layout:collection name="sortiForm" property="listeordre" styleClass="SCROLL" styleClass="FORM" width="500" height="320">
           <layout:collectionItem title="ORDRE" property="ordre" sortable="true"></layout:collectionItem>
           
            <layout:collectionItem title="destination" property="mag" sortable="true"></layout:collectionItem>
            
           <layout:collectionItem title="OUVRIR" property="ouvrir" action="/sortie.do?hidden=ouvrir" paramId="type,whs,code" paramProperty="type,whs,code">
