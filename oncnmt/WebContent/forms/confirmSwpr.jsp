...
<html:html lang="true">
  <head>
    ...
    <title> Confirmation swap Prepaid </title>
 ...
 <layout:skin includeScript="true"/>
  ...
  <body onload="dmdSw(document.swapForm);activer2();">
 ...
 <hr>
     ...
     <layout:form action="/swapPr.do" method="post" onsubmit="return false;">
  ...
  <layout:text property="act_id"  mode="H,H,H"></layout:text>
    ...
    <layout:row >
     ...
     <layout:column>      
              <layout:button onclick="activsubmit(swapForm,'annuler');">Annuler</layout:button>
            </layout:column>
             <layout:column>
                <layout:button onclick="activsubmit(swapForm,'valider');">Valider</layout:button>
            
              </layout:column>
            <layout:column>
                <layout:button onclick="activsubmit(swapForm,'editExcel');">Expoter vers Excel</layout:button>
      ...
      <layout:column>  
      <h3 >
          CONFIRMATION DE CHARGEMENT SWAP PREPAID
      </h3>
  </layout:column>
        </layout:row>
       ...
       <layout:options property="nomArticle"></layout:options>
        ...
        <layout:column>
           <layout:button onclick="testafficher_rang(document.swapForm);">afficher les rangs</layout:button>
       </layout:column>
...
<div style="position:absolute;left:10px;width:850; height:210;overflow-y:scroll; border:solid 1px red;">   
           ...
           <layout:collection name="swapForm" property="swap"  styleClass="SCROLL" styleClass="FORM" width="850" >
           ...
           <layout:collectionItem title="+" property="ajouter" action="/swapPr.do?hidden=afficher" paramId="article,s_str,s_end,qute,rng_id,act_id" paramProperty="article,s_str,s_end,qute,rng_id,act_id">
...
<div style="position:absolute;left:10px;top:360px;">   
   ...
   <tr>
       ...
       <layout:options property="nomArticle"></layout:options>
        ...
        <jsp:include page="champ2.jsp"/>  <layout:space></layout:space>

       <td> <layout:button onclick="addSw(document.swapForm);"> Ajouter </layout:button> </td>
   </tr>
...
<div style="position:absolute;left:10px;top:440px;width:570;overflow-y:scroll;height:140; border:solid 1px red;">   
           ...
           <layout:collection name="swapForm" property="swap2" styleClass="SCROLL" styleClass="FORM" width="550" >
           ...
           <layout:collectionItem title="QTE" property="qt" sortable="true"></layout:collectionItem>
            <layout:collectionItem title="X" property="retirer" action="/swapPr.do?hidden=Retirer" paramId="aaa,stt,see,qtt" paramProperty="aaa,stt,see,qtt">
