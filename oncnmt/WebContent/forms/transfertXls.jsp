...
<jsp:include page="menu.jsp"/>  
 ...
 <layout:form action="/transfert.do" method="post" onsubmit="return false;"  enctype="multipart/form-data" >
      ...
      <layout:text property="hiddenTest"  mode="H,H,H"></layout:text>
        ...
        <layout:column>      
              ...
              <layout:column>
                  <layout:button onclick="activsubmit(document.transfertForm,'valider');">Valider</layout:button>
            </layout:column>
 ...
 <layout:panel key="Informations de Transfert:" styleClass="FORM" width="600">
      
         
      
          <layout:select property="destId" key="Magasin destination :" isRequired="true">
          <layout:options property="listdistId" labelProperty="listdistLabel" ></layout:options>
             
             </layout:select>
             
             
             <layout:select property="magasourc" key="Magasin source:" isRequired="true">
