...
<layout:html>
 ...
 {  if  (document.getElementById('dat_du').value=="" )
   ...
   else
   {
	   ...
	   {
	      alert("Voulez vous compléter les critères pour éditer le rapport SVP");
	      document.getElementById('dist').focus();
	   }
	   else{
   setHidden('edit_rapport_reservation');
...
<jsp:include page="menu.jsp"/>  
  ...
  <layout:text property="hidden" value="default" mode="H,H,H"></layout:text>
       ...
       <layout:panel key="Rapport des réservations :" styleClass="FORM">   
...
<layout:row> 
 ...
 <layout:date property="dat_au" key="Jusqu'à la date Du :" endYear="2020" startYear="1999" patternKey="dd/MM/y" calendarTooltip="Choisir une date" ></layout:date>
     ...
     <layout:row> 
        ...
        <layout:select property="dist" key="Distributeur/CDS :">
