...
<html:html lang="true">
  <head>
    ...
    <title>Confirmation swap Postpaid</title>
...
<jsp:include page="menu.jsp"/>  
 <hr>
     ...
     <layout:form action="/swapPo.do" method="post" onsubmit="return false;">
...
<div style="position:absolute;left:10px;width:850; height:210;overflow-y:scroll; border:solid 1px red;">   
           ...
           <layout:collectionItem title="+" property="ajouter" action="/swapPo.do?hidden=afficher" paramId="article,s_str,s_end,qute,rng_id,act_id" paramProperty="article,s_str,s_end,qute,rng_id,act_id">
...
<div style="position:absolute;left:10px;top:420px;width:570;overflow-y:scroll;height:140; border:solid 1px red;">   
           ...
           <layout:collectionItem title="QTE" property="qt" sortable="true"></layout:collectionItem>
            <layout:collectionItem title="X" property="retirer" action="/swapPo.do?hidden=Retirer" paramId="aaa,stt,see,qtt" paramProperty="aaa,stt,see,qtt">
