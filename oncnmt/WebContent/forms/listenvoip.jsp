     ...
     <layout:space></layout:space>
      ...
      <layout:space></layout:space>
       ...
       <layout:column width="300">
        ...
        <layout:panel  key="liste des  envois packaging" width="500" styleClass="FORM" height="500">
       <center>
      
         <logic:notEmpty property="listeordre" name="envoipackagForm">
         <layout:collection name="envoipackagForm" property="listeordre" styleClass="SCROLL" styleClass="FORM" width="500" height="320">
           ...
           <layout:collectionItem title="OUVRIR" property="ouvrir" action="/recepackag.do?hidden=ouvrir" paramId="type,whs,code" paramProperty="type,whs,code" >
  ...
  <logic:present parameter="hidden" scope="request">
    <logic:equal value="listenvoip" parameter="hidden" scope="request">
       <logic:present name="envoipackagForm" >
         <logic:empty name="envoipackagForm" property="listeordre">
