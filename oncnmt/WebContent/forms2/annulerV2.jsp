...
activsubmit(document.rechercheForm,'valider');     
  ...
  function verif_annuler()
		{
		if(document.rechercheForm.nrec.value=="" &&    document.rechercheForm.debut.value=="" && document.rechercheForm.fin.value=="")
 ...
 <hr>
    ...
    <layout:form action="/annulerV2.do" method="post" onsubmit="return testersubmit();">
      ...
      <layout:panel key="Recherche des transactions :" styleClass="FORM">
       ...
       <layout:row>
                  ...
                  <layout:column>
                        ...
                        <layout:row>
                       <layout:column>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    OU </layout:column>
                       </layout:row>
                       <layout:row> 
