...
<jsp:include page="menu.jsp"/> 
 <hr>
     ...
     <layout:form action="/recepackag.do" method="post" onsubmit="return false;">
      <layout:text property="hidden" value="default" mode="H,H,H"></layout:text>
       <layout:text property="hiddenTest"  key="test" mode="H,H,H"></layout:text>
  ...
  <layout:text property="act_id"  mode="H,H,H"></layout:text>
     ...
     <layout:row>
              ...
              <layout:column>
                 <layout:button onclick="valid2();">Valider</layout:button>
             </layout:column>
           
                
                 <layout:column>
                <layout:button onclick="activsubmit(document.envoipackagForm,'editExcel');">Expoter vers Excel</layout:button>
      ...
      <logic:notEmpty property="resulrang" name="envoipackagForm" >
            <layout:cell>
<div style="position:absolute;left:10px;width:850; height:230;overflow-y:scroll; border:solid 1px red;">   
 
  
 <layout:collection id="item" name="envoipackagForm" property="resulrang"  styleClass="SCROLL" styleClass="FORM" width="850" height="1000">
...
<layout:collectionItem  onclick="recuperparametre('${item.art}','${item.prof}','${item.st}','${item.nd}','${item.rng_id}','${item.act_id}');"    href="javascript:void();" title="ajouter" property="ajouter" sortable="true">
   <center> <layout:img srcName="add.GIF" border="0"></layout:img> </center> 
	     ...
	     <logic:equal value="listenvoip" parameter="hidden" scope="request">
	      <logic:present name="envoipackagForm"   >
	     <logic:empty property="resulrang" name="envoipackagForm" >
	     <layout:panel styleClass="Form"  key="aucun resultat trouvé !" >
	     <layout:message key="aucune  "/>
...
<td> <layout:select property="profil" key="Profil:">
       ...
       <td> <layout:button onclick="testVidd(document.envoipackagForm);"> Ajouter </layout:button> </td>
...
<div style="position:absolute;left:10px;top:420px;width:570;overflow-y:scroll;height:140; border:solid 1px red;">   
           ...
           <layout:collection name="envoipackagForm" property="listajouter" styleClass="SCROLL" styleClass="FORM" width="560" >
           ...
           <layout:collectionItem title="QTE" property="qtt" sortable="true"></layout:collectionItem>
            <layout:collectionItem title="X" property="retirer" action="/recepackag.do?hidden=Retirer" paramId="aaa,ppp,st,see,qt" paramProperty="aaa,ppp,st,see,qt">
...
<div style="position:absolute;left:620px;top:420px;width:250;height:140; border:solid 1px red;">             
 ...
 documents partenaire <layout:text property="doc" key="N° de ref ext:" ></layout:text>        
