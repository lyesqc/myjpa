...
<html:html lang="true">
  <head>
    ...
    <title>Chargement swap Postpaid</title>
 ...
 <hr>
     ...
     <layout:form action="/demandSwpo.do" method="post" onsubmit="return false;">
...
<layout:row >
      ...
      <layout:column>  
      <h3 >
          DEMANDE DE CHARGEMENT SWAP POSTPAID
      </h3>
  </layout:column>
        </layout:row>
...
<div style="position:absolute;left:10px;width:850; height:230;overflow-y:scroll; border:solid 1px red;">   
           ...
           <layout:collectionItem title="+" property="ajouter" action="/demandSwpo.do?hidden=afficher" paramId="article,s_str,s_end,qute,rng_id,act_id" paramProperty="article,s_str,s_end,qute,rng_id,act_id">
...
<div style="position:absolute;left:10px;top:440px;width:570;overflow-y:scroll;height:140; border:solid 1px red;">   
           ...
           <layout:collectionItem title="QTE" property="qt" sortable="true"></layout:collectionItem>
            <layout:collectionItem title="X" property="retirer" action="/demandSwpo.do?hidden=Retirer" paramId="aaa,stt,see,qtt" paramProperty="aaa,stt,see,qtt">
