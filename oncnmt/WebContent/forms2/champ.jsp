...
<%@ page import="com.yourcompany.struts.form.ReceptionLastestActionForm"%>
...
<td> <layout:text property="fin"  size="15"   onmousedown="if (event.button==2){alert('Vous ne pouvez pas  copier le contenu du champ');};" onclick="tester3(document.getElementById('debut'));" onkeydown ="if(event.ctrlKey){event.returnValue = false;alert('Vous ne pouvez pas  copier le contenu du champ');} ;" onkeypress=" if ((event.keyCode!=13)&&(event.keyCode!=48)&&(event.keyCode!=49)&&(event.keyCode!=50)&&(event.keyCode!=51)&&(event.keyCode!=52)&&(event.keyCode!=53)&&(event.keyCode!=54)&&(event.keyCode!=55)&&(event.keyCode!=56)&&(event.keyCode!=57)) { event.returnValue = false;alert('vous ne pouvez utiliser que des touches numériques!');};if (event.keyCode==13){affPrompt(document.getElementById('fin'),document.getElementById('le_prompt1'),document.getElementById('sup1'))};" key="N° fin"    onfocus="testArt2(document.getElementById('debut'));"   onblur="tester2(document.getElementById('fin'));"></layout:text> </td>