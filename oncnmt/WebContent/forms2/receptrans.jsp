...
<jsp:include page="menu.jsp"/>  
 <hr>
     ...
     <layout:form action="/receptrans.do" method="post" onsubmit="return false;">
...
<div style="position:absolute;left:10px;width:850; height:230;overflow-y:scroll; border:solid 1px red;">   
        <layout:collection id="item" name="transfert1Form" property="resulrang"  styleClass="SCROLL" styleClass="FORM" width="850" >
...
<div style="position:absolute;left:10px;top:420px;width:570;overflow-y:scroll;height:140; border:solid 1px red;">   
           ...
           <layout:collectionItem title="QTE" property="qtt" sortable="true"></layout:collectionItem>
            <layout:collectionItem title="X" property="retirer" action="/receptrans.do?hidden=Retirer" paramId="aaa,ppp,st,see,qt" paramProperty="aaa,ppp,st,see,qt">
