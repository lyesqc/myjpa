 ...
 <hr>
  ...
  <layout:text property="act_id"  mode="H,H,H"></layout:text>
    ...
    <layout:row>
              ...
              <layout:column >
                <layout:button onclick="valid1();">Valider</layout:button>
                 </layout:column >
                  
              
               <layout:column>
                <layout:button onclick="activsubmit(document.envoiForm,'editExcel');">Expoter vers Excel</layout:button>
...
<div style="position:absolute;left:10px;width:850; height:230;overflow-y:scroll; border:solid 1px red;">   
           ...
           <layout:collection id="item" name="envoiForm" property="resulrang"  styleClass="SCROLL" styleClass="FORM" width="830">
...
<jsp:include page="champ.jsp"/> 
      <td> <layout:select property="profil" key="Profil:">
       ...
       <td> <layout:button onclick="testVidd(document.envoiForm);"> Ajouter </layout:button> </td>
...
<div style="position:absolute;left:10px;top:420px;width:570;overflow-y:scroll;height:140; border:solid 1px red;">   
           ...
           <layout:collection name="envoiForm" property="listajouter" styleClass="SCROLL" styleClass="FORM" width="560">
           ...
           <layout:collectionItem title="QTE" property="qtt" sortable="true"></layout:collectionItem>
            <layout:collectionItem title="X" property="retirer" action="/envoi.do?hidden=Retirer" paramId="aaa,ppp,st,see,qt" paramProperty="aaa,ppp,st,see,qt">
...
<layout:text property="doc" key="N° de REF EXT:" ></layout:text>        
