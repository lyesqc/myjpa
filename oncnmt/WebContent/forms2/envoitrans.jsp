...
<jsp:include page="menu.jsp"/>  
 <hr>
     ...
     <layout:form action="/envoitrans.do" method="post" onsubmit="return false;">
  ...
  <layout:text property="act_id"  mode="H,H,H"></layout:text>
   ...
   <layout:row >
                ...
                <layout:column>
                <layout:button onclick="activsubmit(document.transfert1Form,'editExcel');">Expoter vers Excel</layout:button>
             ...
             <layout:column>
               ...
               <layout:button onclick="valid4();">Valider</layout:button>
             </layout:column>
...
<layout:collection id="item" name="transfert1Form" property="resulrang"  styleClass="SCROLL" styleClass="FORM" width="850" height="1000">
...
<td> <layout:select property="profil" key="Profil:">
       ...
       <layout:options property="listprof"></layout:options>
        ...
        <td> <layout:button onclick="testVidd(document.transfert1Form);"> Ajouter </layout:button> </td>
...
<div style="position:absolute;left:10px;top:420px;width:570;overflow-y:scroll;height:140; border:solid 1px red;">   
           ...
           <layout:collection name="transfert1Form" property="listajouter" styleClass="SCROLL" styleClass="FORM" width="550">
           ...
           <layout:collectionItem title="QTE" property="qtt" sortable="true"></layout:collectionItem>
            <layout:collectionItem title="X" property="retirer" action="/envoitrans.do?hidden=Retirer" paramId="aaa,ppp,st,see,qt" paramProperty="aaa,ppp,st,see,qt">
...
<layout:text property="doc" key="No Ref Ext:" ></layout:text>        
