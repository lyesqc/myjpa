...
<html:html lang="true">           
 ...
 <layout:skin includeScript="true"/>
  ...
  <body onload="confirmm(document.activationPreForm);activer2();">

 <jsp:include page="menu.jsp"/>  
 <hr>

     <layout:form action="/confirmPrepaid.do" method="post" onsubmit="return testersubmit();">
 ...
 <layout:row>
  ...
  <layout:column>      
              <layout:button onclick="activsubmit(document.activationPreForm,'annuler');">Annuler</layout:button>
            </layout:column>
             <layout:column>
                <layout:button onclick="activsubmit(document.activationPreForm,'valider');">Valider</layout:button>
            
              </layout:column>
            <layout:column>
                <layout:button onclick="activsubmit(document.activationPreForm,'editExcel');">Expoter vers Excel</layout:button>
      ...
      CONFIRMATION PREPAID
       ...
       <jsp:include page="fltre_hlr.jsp"/>
 <layout:column>
           <layout:button onclick="testafficher_rang(document.activationPreForm);">afficher les rangs</layout:button>
       </layout:column>
       
       </layout:row> 
  
       <layout:cell>
<div style="position:absolute;left:10px;width:850; height:210;overflow-y:scroll; border:solid 1px red;">   
 
 <layout:collection name="activationPreForm" property="prepaid"  styleClass="SCROLL" styleClass="FORM" width="850">
           ...
           <layout:collectionItem title="+" property="ajout" action="/confirmPrepaid.do?hidden=afficher" paramId="art1,s_str1,s_end1,qt1,rng_id,act_id" paramProperty="art1,s_str1,s_end1,qt1,rng_id,act_id">
...
<jsp:include page="champ2.jsp"/>
       ...
       <td> <layout:button onclick="add2(document.activationPreForm);"> Ajouter </layout:button> </td>
   </tr>
...
<div style="position:absolute;left:10px;top:420px;width:570;overflow-y:scroll;height:140; border:solid 1px red;">   
           ...
           <layout:collection name="activationPreForm" property="prepaid2" styleClass="SCROLL" styleClass="FORM" width="550">
          ...
          <layout:collectionItem title="PQ" property="pp" sortable="true"></layout:collectionItem>
            
          <layout:collectionItem title="QTE" property="qt" sortable="true"></layout:collectionItem>
           <layout:collectionItem title="X" property="retirer" action="/confirmPrepaid.do?hidden=Retirer" paramId="aaa,stt,see,qtt,ppp" paramProperty="aaa,stt,see,qtt,ppp">
