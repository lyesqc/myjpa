...
<html:html lang="true">
  <head>
    ...
    <title>Chargement swap Prepaid</title>
...
<jsp:include page="menu.jsp"/>  
 <hr>
     ...
     <layout:form action="/demandSwpr.do" method="post" onsubmit="return false;">
  ...
  <layout:text property="act_id"  mode="H,H,H"></layout:text>
    ...
    <layout:row >
      ...
      <layout:column>  
      <h3 >
          DEMANDE DE CHARGEMENT SWAP PREPAID
      </h3>
  </layout:column>
        </layout:row>
...
<div style="position:absolute;left:10px;width:850; height:210;overflow-y:scroll; border:solid 1px red;">   
           ...
           <layout:collectionItem title="+" property="ajouter" action="/demandSwpr.do?hidden=afficher" paramId="article,s_str,s_end,qute,rng_id,act_id" paramProperty="article,s_str,s_end,qute,rng_id,act_id">
...
<div style="position:absolute;left:10px;top:440px;width:570;overflow-y:scroll;height:140; border:solid 1px red;">   
           ...
           <layout:collectionItem title="QTE" property="qt" sortable="true"></layout:collectionItem>
            <layout:collectionItem title="X" property="retirer" action="/demandSwpr.do?hidden=Retirer" paramId="aaa,,stt,see,qtt" paramProperty="aaa,stt,see,qtt">
