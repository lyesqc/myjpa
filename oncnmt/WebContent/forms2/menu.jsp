...
if ((profi.getProf().equals("CONFIRMATION PROMOTION"))){
String whs=profi.getWhs();
...
<%break;}}%>  
        ...
        <layout:menuItem key="affectation profil postpaid" >  
                   <%
...
if (profi.getProf().equals("AFFECTATION PROFIL POSTPAID")){
String whs=profi.getWhs();
request.getSession().setAttribute("affprofpre",whs);

%>                   
                     
                     <layout:menuItem key="Demande d'affectation" page="/nonactivpost.do?param=demandprofilpost"> </layout:menuItem>
...
if ((profi.getProf().equals("CONFIRMATION PROFIL POSTPAID"))){
String whs=profi.getWhs();
request.getSession().setAttribute("confprofpre",whs);
...
%> 
                    ...
                    <layout:menuItem key="Confirmation d'affectation" page="/confirmSwpo.do?param=confirmprofilpost">   </layout:menuItem>
...
<layout:menuItem key="Dépackaging des Sims">     
<%     

ArrayList DPA = new ArrayList();
 DPA= (ArrayList)request.getSession().getAttribute("privilege");
for ( int i=0;i<DPA.size();i++){
Profil profi =(Profil)DPA.get(i);

if (profi.getProf().equals("DEPACKAGING")){

	
%>
    <layout:menuItem key="Dépackaging des Sims"  page="/nonactivpost.do?param=depackaging"> </layout:menuItem>             
...
%>
               ...
               <layout:menuItem key="annuler une transaction V2" page="/annulerV2.do?hidden=afficher"></layout:menuItem> 
...
%>                   
<layout:menuItem key="Rapport global"   page="/rapport_global.do?hidden=initial_rapport"></layout:menuItem>
